...
# USED FOR ARCHIVAL SEARCHES, NOT LIVE SEARCHING
class ThemeParkInsider(Translator):
    def __init__(self, keywords_file):
        self.relevant_prefix = "https://www.themeparkinsider.com/flume/" #the links to the pages that matter
        self.url = "https://www.themeparkinsider.com/"
